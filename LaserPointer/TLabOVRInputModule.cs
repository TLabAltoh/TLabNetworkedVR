...
namespace UnityEngine.EventSystems
{
    ...
    public class TLabOVRInputModule : PointerInputModule
    {
        ...
        public Transform rayTransformLeft, rayTransformRight;
        ...
        public override void Process()
        {
            ...
            if (m_rightPressing == false || m_leftPressing == true)
            {
                ...
                if (m_leftPressing == true) m_leftPressing = !leftState.AnyReleasesThisFrame();
                else                        m_leftPressing = leftState.AnyPressesThisFrame();
            }
            ...
            if (m_leftPressing == false || m_rightPressing == true)
            {
                ...
                if (m_rightPressing == true)    m_rightPressing = !rightState.AnyReleasesThisFrame();
                else                            m_rightPressing = rightState.AnyPressesThisFrame();
            }
        ...
        {
            if (pressed || released || IsPointerMoving(pointerData) || pointerData.IsScrolling()) return true;
        ...
        virtual protected MouseState GetGazePointerData(Transform rayTransform, OVRCursor cursor, OVRInput.Controller controller)
        {
            ...
            cursor.SetCursorRay(rayTransform);
            ...
            if (ovrRaycaster)
            {
                ...
                if (graphicRect != null)
                {
                    ...
                    cursor.SetCursorStartDest(rayTransform.position, worldPos, normal);
                }
            }
            ...
            if (physicsRaycaster)
            {
                ...
                cursor.SetCursorStartDest(rayTransform.position, position, raycast.worldNormal);
            }
            ...
            m_MouseState.SetButtonState(PointerEventData.InputButton.Left, GetGazeButtonState(controller), leftData);
        ...
        {
            if (pointerEvent.IsVRPointer()) return true;
            else return pointerEvent.IsPointerMoving();
        }
